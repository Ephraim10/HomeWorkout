...
class RotActivity : AppCompatActivity() {
    ...
    private fun startTimer() {
        ...
        countDownTimer = object : CountDownTimer(MTimeLeftinmills, 1000) {
            ...
            override fun onFinish() {
                ...
                if (newvalue <= 7) {
                    val intent = Intent(this@RotActivity, MainActivity2::class.java).apply {
    ...
    override fun onBackPressed() {
        val intent = Intent(this@RotActivity, MainActivity2::class.java)
        startActivity(intent)
        finish()
